                ...
                <div class="pvr_card">
                    <div class="body">
                        <div class="row">
                            ...
                            <form class="col-lg-12" id="sign_in" action="<?php echo base_url();?>index.php/login/checkLogin" method="POST" autocomplete="off">
                                <h5 class="title f-s-20 f-w-500">Sign in to your Account</h5>
                                <div class="form-group-pvr form-float">
                                    <div class="form-line-pvr">
                                        <input type="text" name="mobile_no" id="mobile_no" class="form-control" onkeypress="return isNumber(event)" value="<?php echo set_value('mobile_no') ?>" maxlength="10">
                                        <label class="form-label" id="mlbl">Mobile Number</label>
                                    </div>
                                ...
                                <div class="form-group-pvr form-float m-b-10">
                                    <div class="form-line-pvr">
                                        ...
                                        <label class="form-label" id="plbl">Password</label>
                                    </div>
                            ...
                            <div class="col-lg-12 m-t-8">                            
                                <a class="" href="<?php echo base_url();?>index.php/login/forgotPassword">Forgot Password?</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        if((mobile_no != '')){
            $('#mlbl').css({'top': '-10px','font-size': '12px'});
        }

        if((password != '')){
            $('#plbl').css({'top': '-10px','font-size': '12px'});
        }
    });
