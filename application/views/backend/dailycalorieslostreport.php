        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-pvr">
                <div class="panel-heading">
                    <h4 class="panel-title">Daily Calories Lost Report</h4>
                </div>
                <div class="panel-body">
                    
                    <form action="<?php echo base_url();?>index.php/reports/getdailycalorieslostReport" method="POST" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4" style="margin-top: 25px;">
                                ...
                                <a href="<?php echo base_url();?>index.php/reports/dailycaloriesreportform" class="btn btn-sm btn-warning pull-left m-r-5" title="Cancel">Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>
